...
from ..utility.constant import STRUCTURE_BIOME
...
class StructureStructure(models.Model):
    ...
    def popolate_structure_biome(self):
        """Crea le strutture e le collega ai biomi basandosi sul dizionario STRUCTURE_BIOME.
        ...
        for structure, list_biome_name in STRUCTURE_BIOME.items():
